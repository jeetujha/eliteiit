...
class Admin_testimonials_model extends CI_Model {
    ...
    * @return int
    */
    function count_testinomails($search_string=null, $order=null)
    {
		$this->db->select('*');
		$this->db->from('testing_testimonials');
		if($search_string){
    ...
    */
    ...
    {
		$insert = $this->db->insert('testing_testimonials', $data);
	    return $insert;
	}
    ...
    */
    ...
    {
		$this->db->where('id', $id);
		$this->db->update('testing_testimonials', $data);
	}
    ...
    * @return boolean
    */
	function delete_testimonails($id){
		$this->db->where('id', $id);
		$this->db->delete('testing_testimonials'); 
	}
